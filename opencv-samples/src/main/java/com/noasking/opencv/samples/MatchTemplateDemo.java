package com.noasking.opencv.samples;

/**
 * Created by MaJing on 2018/2/7.
 */
...
class MatchTemplateDemoRun implements ChangeListener{
    ...
    private void matchingMethod() {
        ...
        Imgproc.rectangle(img_display, matchLoc, new Point(matchLoc.x + templ.cols(),
                matchLoc.y + templ.rows()), new Scalar(255, 0, 0), 2, 8, 0);
...
public class MatchTemplateDemo
{
    public static void main(String[] args) {
        ...
        // run code
        args = new String[]{"D:\\TEMP\\aaa\\20180130211723_2.jpg","D:\\TEMP\\aaa\\32.jpg"};
